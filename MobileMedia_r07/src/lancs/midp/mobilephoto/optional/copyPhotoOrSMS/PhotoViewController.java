...
package lancs.midp.mobilephoto.optional.copyPhotoOrSMS;
 ...
 */
@Features({@Feature(name="CopyPhoto", parent="MobileMediaAO", type=FeatureType.optional),@Feature(name="SMSTransfer", parent="MobileMediaAO", type=FeatureType.optional)})
