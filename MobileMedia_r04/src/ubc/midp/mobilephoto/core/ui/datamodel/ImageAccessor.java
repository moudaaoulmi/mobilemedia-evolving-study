...
public class ImageAccessor {
	...
	public void addImageData(String photoname, String path, String albumname)
			...
			ii.setRecordId(rid2);
			data1 = converter.getBytesFromImageInfo(ii).getBytes();
...
//		System.out.println("<*ImageAcessor.loadImageDataFromRMS*> before RecordStore");
...
//		System.out.println("<*ImageAcessor.loadImageDataFromRMS*> after RecordStore");
...
//			System.out.println("<*ImageAcessor.loadImageDataFromRMS*> image = "+iiObject.getImageLabel());
	...
	public boolean updateImageInfo(ImageData oldData, ImageData newData) throws InvalidImageDataException, PersistenceMechanismException {
		...
		RecordStore infoStore = null;
			...
			ImageUtil converter = new ImageUtil();
			byte[] imageDataBytes = converter.getBytesFromImageInfo(newData).getBytes();
