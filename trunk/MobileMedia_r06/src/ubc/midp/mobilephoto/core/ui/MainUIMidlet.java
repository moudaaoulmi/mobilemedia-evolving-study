...
public class MainUIMidlet extends MIDlet {
	...
	// Add in scenario 05: to expose the album attribute to the SMSAspect
	private AlbumListScreen album;

	// Add in scenario 05: to expose the albumController attribute to the SMSAspect
	...
	public void startApp() throws MIDletStateChangeException {
		...
		albumController = new AlbumController(this, model, album);
